...
const validationMessage = [
    ...
    {message: 'Hanya huruf, angka, dan tanda baca umum yang dapat digunakan', key: 'allowedChar'},
]
...
function hasAllowedCharacters(str) {
...
watch(password, (newValue) => {
    ...
    isContain.allowedChar = hasAllowedCharacters(newValue);
});
</script>
