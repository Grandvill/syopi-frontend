                ...
                <div v-for="i in 5" :key="`product-${i}`" class="cart-product">
                    <div class="w-[46%]">
                        <div class="flex gap-3 text-sm items-center">
                            <img src="https://picsum.photos/1920/1080?random=1" class="aspect-[1/1] w-20" />
                            <p class="line-clamp-2 text-black/85">Kaos Game Over Pixelo - T-shirt / Tees Gamer PS Nintendo Game Retro & Kaos 90an </p>
                            <div class="w-40">
                                <p>Variasi: </p>
                                <p>Hitam, XXL</p>
                            </div>
                    ...
                    <div class="text-center w-[15%] text-primary">Rp{{ formatNumber(190000) }}</div>
                    <div class="text-center w-[10%]">
                        <UButton variant="link">Hapus</UButton>
                    </div>
                </div>
            </div>
        </UCard>
                        ...
                        <UCheckbox>
                            <template #label>
                                <div class="flex gap-2">
                                    <IconCoin />
                                    <span class="font-medium">Koin Syopi</span>
                                </div>
                            </template>
                        </UCheckbox>
                        <span class="font-medium text-sm text-gray-500">Saldo Koin Tidak Cukup</span>
                    ...
                    <div class="flex gap-4">
                        <div>
                            <div class="flex items-center gap-1">
                                ...
                                <span class="text-primary font-normal text-2xl">Rp{{ formatNumber(145000) }}</span>
                            </div>
                        ...
                        <UButton class="px-9 min-w-52 justify-center" @click="handleCheckout">Checkout</UButton>
                    </div>
                </div>
...
const paddingCheckoutFooter = 'sm:py-2 sm:px-7'
