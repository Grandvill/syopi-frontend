      ...
      <div class="product-briefing">
        ...
        <div class="product-information">
          <div class="product-title">
            ...
            <UButton class="mt-6" variant="soft" to="/Cart">
              <IconCartPlus />
              Masukkan Keranjang
            </UButton>
            <hr class="my-5" />
    ...
    <UCard>
      ...
      <div class="mt-3 border border-primary-100/80 bg-primary-50/30 rounded-sm p-8 flex gap-8 items-center">
        ...
        <div class="flex flex-wrap gap-2 items-center">
          ...
          <div class="flex flex-row-reserve gap-2">
            <UButton 
            v-for="(i, index) in 5" 
            :key="`rating-${i}`"
            color="white" 
            size="xs" 
            class="min-w-24 text-sm justify-center"
            >{{ i }} ({{ dataDummy.review_summary[index] || 0 }})</UButton>
          </div>
          <UButton 
          color="white" 
          size="xs" 
...
const dataDummy = computed(() => {
  return {
    ...
    seller: {
      ...
      photo_url: 'http://localhost:8000/storage/user-photo/iAdzpaTT8wNzF58ZQ67Ys4YwTzFnQHW3tLFY3msm.jpg',
      product_count: 33,
      rating_count: 66,
    ...
    images: ['http://localhost:8000/storage/attachment2.jpg', 'http://localhost:8000/storage/attachment4.jpg', 'http://localhost:8000/storage/attachment1.jpg', 'http://localhost:8000/storage/attachment3.jpg'],
    variations: [
      {
        name: 'Ukuran',
        values: ['M', 'L', 'XL'],
